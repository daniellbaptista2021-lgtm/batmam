...
.hl-icon{flex-shrink:0;width:48px;height:48px;display:flex;align-items:center;justify-content:center;background:rgba(155,89,252,.08);border-radius:12px}
...
.plat{width:36px;height:36px;display:flex;align-items:center;justify-content:center;background:rgba(155,89,252,.06);border:1px solid var(--bd);border-radius:10px;transition:all .4s cubic-bezier(.25,.8,.25,1);transform-style:preserve-3d;cursor:default}
.plat:hover{transform:perspective(400px) rotateY(180deg) scale(1.1);border-color:rgba(155,89,252,.4);background:rgba(155,89,252,.12);box-shadow:0 8px 20px rgba(0,0,0,.3)}
.plat svg{width:20px;height:20px;fill:var(--t2);transition:fill .3s}
.plat:hover svg{fill:var(--p)}
...
<section style="padding:0 20px 40px;position:relative;z-index:1">
  <div class="highlights">
    <div class="hl"><div class="hl-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#9B59FC" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg></div><div><div class="hl-title">Funciona em qualquer lugar</div><div class="hl-desc">Terminal, VS Code, navegador, celular. Comece no PC, continue no celular. Teleport transfere sua sess&atilde;o entre dispositivos.</div><div class="platforms"><div class="plat" title="Terminal"><svg viewBox="0 0 24 24"><path d="M4 17l6-5-6-5M12 19h8"/></svg></div><div class="plat" title="VS Code"><svg viewBox="0 0 24 24"><path d="M17.5 2L9 10.5 4.5 7 3 8l6 5-6 5 1.5 1L9 15.5 17.5 22l2.5-1V3z"/></svg></div><div class="plat" title="Chrome"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="4"/><path d="M21.17 8H12M8 12l-4.17 7.17M12 16l4.17 7.17"/></svg></div><div class="plat" title="Android"><svg viewBox="0 0 24 24"><path d="M5 16V9h14v7M7 21v-5M17 21v-5M4 9l2.5-5M20 9l-2.5-5M9 4h6"/><circle cx="9" cy="6" r=".5"/><circle cx="15" cy="6" r=".5"/></svg></div><div class="plat" title="iPhone"><svg viewBox="0 0 24 24"><rect x="5" y="2" width="14" height="20" rx="2"/><path d="M12 18h.01"/></svg></div><div class="plat" title="PWA"><svg viewBox="0 0 24 24"><path d="M12 2L2 7l10 5 10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg></div></div></div></div>
    <div class="hl"><div class="hl-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#4A9EFF" stroke-width="2"><path d="M12 2a7 7 0 017 7c0 3-2 5-4 7l-3 4-3-4c-2-2-4-4-4-7a7 7 0 017-7z"/><circle cx="12" cy="9" r="2.5"/></svg></div><div><div class="hl-title">Intelig&ecirc;ncia de ponta</div><div class="hl-desc">Claude Sonnet 4 com Extended Thinking. O mesmo modelo que alimenta as maiores plataformas de AI coding do mundo. Pensa antes de agir.</div><div class="platforms"><div class="plat" title="Anthropic Claude"><svg viewBox="0 0 24 24"><path d="M15.3 3L21 21h-4.2l-1.5-4.8h-6.6L7.2 21H3L8.7 3h6.6zm-2.1 10.2L12 8.4l-1.2 4.8h2.4z"/></svg></div><div class="plat" title="Sonnet 4"><svg viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01z"/></svg></div></div></div></div>
    <div class="hl"><div class="hl-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#34D399" stroke-width="2"><rect x="5" y="2" width="14" height="20" rx="3"/><path d="M12 18h.01"/><path d="M9 6h6"/></svg></div><div><div class="hl-title">Dev completo no bolso</div><div class="hl-desc">Crie apps, landing pages, APIs, planilhas, PDFs, apresenta&ccedil;&otilde;es. Tudo pelo celular via PWA. Instala como app nativo em 10 segundos.</div><div class="platforms"><div class="plat" title="HTML"><svg viewBox="0 0 24 24"><path d="M4 4l1.77 16L12 22l6.23-2L20 4zm11.34 5.54H8.66l.22 2.5h6.24l-.44 4.7L12 17.7l-2.68-.96-.18-2.07h2.46l.09 1.07 .31.11.31-.11.04-.73h-5.5l-.44-5.47h10.92z"/></svg></div><div class="plat" title="Excel"><svg viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M8 7l4 5-4 5M12 7l4 5-4 5"/></svg></div><div class="plat" title="PDF"><svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M9 15h6"/></svg></div><div class="plat" title="PowerPoint"><svg viewBox="0 0 24 24"><rect x="4" y="4" width="16" height="16" rx="2"/><circle cx="12" cy="12" r="3"/></svg></div></div></div></div>
    <div class="hl"><div class="hl-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#F59E0B" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"/></svg></div><div><div class="hl-title">Automa&ccedil;&otilde;es em portugu&ecirc;s</div><div class="hl-desc">&ldquo;Todo dia &agrave;s 8h verifica minhas issues&rdquo; &mdash; diga o que quer e o Clow cria a automa&ccedil;&atilde;o. Sem c&oacute;digo, sem config, s&oacute; linguagem natural.</div><div class="platforms"><div class="plat" title="GitHub"><svg viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12c0 4.42 2.87 8.17 6.84 9.49.5.09.68-.22.68-.48v-1.7c-2.78.6-3.37-1.34-3.37-1.34-.46-1.16-1.11-1.47-1.11-1.47-.91-.62.07-.61.07-.61 1 .07 1.53 1.03 1.53 1.03.89 1.53 2.34 1.09 2.91.83.09-.65.35-1.09.63-1.34-2.22-.25-4.55-1.11-4.55-4.94 0-1.09.39-1.98 1.03-2.68-.1-.25-.45-1.27.1-2.64 0 0 .84-.27 2.75 1.02A9.56 9.56 0 0112 6.8c.85 0 1.71.11 2.5.33 1.91-1.29 2.75-1.02 2.75-1.02.55 1.37.2 2.39.1 2.64.64.7 1.03 1.59 1.03 2.68 0 3.84-2.34 4.68-4.57 4.93.36.31.68.92.68 1.85v2.74c0 .27.18.58.69.48A10 10 0 0022 12c0-5.52-4.48-10-10-10z"/></svg></div><div class="plat" title="n8n"><svg viewBox="0 0 24 24"><circle cx="6" cy="12" r="3"/><circle cx="18" cy="6" r="3"/><circle cx="18" cy="18" r="3"/><path d="M9 12h3l3-6M12 12l3 6"/></svg></div><div class="plat" title="WhatsApp"><svg viewBox="0 0 24 24"><path d="M17.47 14.38c-.29-.14-1.7-.84-1.96-.93-.27-.1-.46-.15-.65.14-.19.3-.74.93-.91 1.12-.17.19-.33.22-.62.07-.29-.14-1.22-.45-2.33-1.43-.86-.77-1.44-1.72-1.61-2.01-.17-.29-.02-.45.13-.59.13-.13.29-.33.43-.5.15-.17.19-.29.29-.48.1-.19.05-.36-.02-.5-.07-.15-.65-1.56-.89-2.14-.24-.56-.48-.48-.65-.49h-.56c-.19 0-.5.07-.77.36s-1.01.99-1.01 2.41c0 1.43 1.04 2.81 1.18 3 .15.19 2.04 3.12 4.94 4.38.69.3 1.23.48 1.65.61.69.22 1.32.19 1.82.12.55-.08 1.7-.7 1.94-1.37.24-.67.24-1.25.17-1.37-.07-.12-.27-.19-.56-.34z"/><path d="M12 2a10 10 0 00-8.68 14.95L2 22l5.23-1.37A10 10 0 1012 2z"/></svg></div></div></div></div>
    <div class="hl"><div class="hl-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#A78BFA" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"/></svg></div><div><div class="hl-title">5 agentes trabalhando juntos</div><div class="hl-desc">Architect planeja, Developer implementa, Tester valida, Reviewer revisa. Ou use Swarm para tarefas brutais em paralelo com git worktrees.</div><div class="platforms"><div class="plat" title="Architect"><svg viewBox="0 0 24 24"><path d="M2 20h20M5 20V8l7-5 7 5v12M9 20v-6h6v6"/></svg></div><div class="plat" title="Developer"><svg viewBox="0 0 24 24"><path d="M16 18l6-6-6-6M8 6l-6 6 6 6"/></svg></div><div class="plat" title="Tester"><svg viewBox="0 0 24 24"><path d="M9 11l3 3L22 4M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg></div><div class="plat" title="Reviewer"><svg viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg></div></div></div></div>
