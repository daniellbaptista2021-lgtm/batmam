...
async function init(){
  try{const r=await fetch('/api/v1/me');me=await r.json();
    ...
    if(_s.indexOf(_p)>=0||me.is_admin){var _crm=document.getElementById('btnCrm');if(_crm)_crm.style.display='flex';var _c=document.getElementById('secConexoes');if(_c)_c.style.display='';}
