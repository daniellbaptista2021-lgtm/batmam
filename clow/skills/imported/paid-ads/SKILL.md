...
## Metodologia Andromeda (PADRAO para Meta Ads)

A metodologia padrao deste sistema para Meta Ads e a Andromeda:

### Principios:
1. CBO SEMPRE (Campaign Budget Optimization) — nunca ABO
2. Segmentacao BROAD — sem interesses, sem lookalike no inicio
3. Criativo como sinal de audiencia — o algoritmo do Meta encontra o publico pelo criativo
4. Estrutura: 1 campanha CBO > 3-5 conjuntos com criativos diferentes > cada conjunto com 1 anuncio
5. Orcamento inicial: R$20-50/dia por campanha
6. Regra de escalonamento: se CPA < meta por 3 dias > duplicar orcamento
7. Regra de pausa: se CPA > 2x meta por 2 dias > pausar conjunto
8. Fadiga de criativo: frequencia > 3 + CTR caindo = hora de trocar criativo
9. Duplicacao horizontal: duplicar conjunto vencedor, nao aumentar orcamento dele
10. Nunca editar anuncio ativo — sempre duplicar

### Analise Andromeda:
Ao analisar campanhas, sempre verificar:
- CBO esta ativo? Se nao, recomendar migracao
- Segmentacao esta broad? Se tem interesses, recomendar remocao
- Quantos criativos por conjunto? Ideal: 1 anuncio por conjunto
- Frequencia de cada conjunto
- CPA vs meta definida
