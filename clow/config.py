...
# Sonnet addon (System Clow premium)
# Sonnet addon - IDs canonicos (BASICO/MEDIO/PRO_PACK). Fallback p/ legacy STARTER/PRO/BUSINESS
STRIPE_PRICE_SONNET_STARTER = os.getenv("STRIPE_PRICE_SONNET_STARTER", "")
STRIPE_PRICE_SONNET_PRO = os.getenv("STRIPE_PRICE_SONNET_PRO", "")
STRIPE_PRICE_SONNET_BUSINESS = os.getenv("STRIPE_PRICE_SONNET_BUSINESS", "")
STRIPE_PRICE_SONNET_BASICO = os.getenv("STRIPE_PRICE_SONNET_BASICO", "") or STRIPE_PRICE_SONNET_STARTER
STRIPE_PRICE_SONNET_MEDIO = os.getenv("STRIPE_PRICE_SONNET_MEDIO", "") or STRIPE_PRICE_SONNET_PRO
STRIPE_PRICE_SONNET_PRO_PACK = os.getenv("STRIPE_PRICE_SONNET_PRO_PACK", "") or STRIPE_PRICE_SONNET_BUSINESS
SYSTEM_CLOW_URL = os.getenv("SYSTEM_CLOW_URL", "https://system-clow.pvcorretor01.com.br")
SYSTEM_CLOW_INTERNAL_SECRET = os.getenv("SYSTEM_CLOW_INTERNAL_SECRET", "")
