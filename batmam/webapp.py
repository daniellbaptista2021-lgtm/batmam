"""Batmam Web App — FastAPI + WebSocket com UI estilo Claude Code.
...
app = FastAPI(title="Batmam", version=__version__) if HAS_FASTAPI else None
...
<title>Batmam — AI Code Agent</title>
<style>
  :root {
    --bg-primary: #0d1117;
    --bg-secondary: #161b22;
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .thinking-icon { font-size: 24px; animation: batmam-thinking 1.5s ease-in-out infinite; }
...
<div class="messages" id="messages">
  <div class="message assistant">
    <div class="msg-label">🦇 Batmam</div>
...
function ensureAssistantEl() {
  if (!currentAssistantEl) {
    ...
    currentAssistantEl.innerHTML = '<div class="msg-label">🦇 Batmam</div>';
